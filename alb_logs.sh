...
show_help() {
    ...
    echo -e "    \033[32m$0\033[0m \033[36m/burn\033[0m \033[35m60\033[0m                   # Show /burn requests from prod (last 60 minutes, fresh)"
    echo -e "    \033[32m$0\033[0m \033[36m/cart\033[0m \033[35m30\033[0m \033[31m--env\033[0m \033[33mstaging\033[0m     # Show /cart requests from staging (last 30 min, fresh)"
    echo -e "    \033[32m$0\033[0m \033[36m/pay\033[0m \033[35m15\033[0m \033[31m--cache\033[0m            # Show /pay requests, use smart cache (15 min)"
    echo -e "    \033[32m$0\033[0m \033[36m/notifications\033[0m \033[35m360\033[0m \033[31m--env\033[0m \033[34mdev\033[0m \033[31m--cache\033[0m  # Dev environment, cached data (6 hours)"
    echo ""
